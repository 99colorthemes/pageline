...
function pageline_footer_copyright_info() {
   ...
   $wp_link = '<a href="'.esc_url( 'http://wordpress.org' ).'" target="_blank" title="' . esc_attr__( 'WordPress', 'pageline' ) . '"><span>' . esc_html__( 'WordPress', 'pageline' ) . '</span></a>';

	$tm_link =  '<a href="'. 'http://99colorthemes.com/' .'" target="_blank" title="'.esc_attr__( '99colorthemes', 'pageline' ).'" rel="designer">'.esc_html__( '99colorthemes', 'pageline') .'</a>';

	$default_footer_value = '<p>'.sprintf( esc_html__( 'Copyright &copy; %1$s %2$s. All rights reserved.', 'pageline' ), date( 'Y' ), $site_link ) . '</p><p>'.sprintf( __( 'Powered by %s.', 'pageline' ), $wp_link ).' ' . sprintf( esc_html__( 'Theme by %s.', 'pageline' ), $tm_link ).'</p>';
