...
function pageline_scripts() {
	...
	//Register pageline main style
	wp_enqueue_style( 'pageline-main', get_template_directory_uri() . '/css/style.css', false, '1.0.0' );
	...
	wp_enqueue_script( 'jquery-malihu-pagescroll2id', get_template_directory_uri() . '/js/jquery.malihu.PageScroll2id.min.js', array( 'jquery' ), '1.5.4', true );
